...
#   enable_dns_hostnames = var.enable_dns_hostnames # DNS hostname can access like .inspiredevops.online 
...
# }
# # its depends on internet gateway , without internet gateway natgateway not working
...
# # create route for private through Nat Gateway
...
# # create route for database through Nat Gateway
...
# # route table association to database
